...
<SpecSheet caption="The rig, item by item. Both kinds of rig carry all five.">
  ...
  <SpecRow term="Render time">Tens of seconds to minutes per five-second take, plus queue time and a metered cost on an API rig — before counting the takes thrown away.</SpecRow>
</SpecSheet>
